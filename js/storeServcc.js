function fetchServices(term = '') {
    const url = term ? `../php/buscar_serv.php?term=${encodeURIComponent(term)}` : '../php/services.php';
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            data.forEach((service) => {
                ...
                serviceElement.setAttribute('data-value', service.servicioID);
                serviceElement.innerHTML = `
                <div class="box-product__container-img">    
                    <div class="box-product__id">${service.servicioID}</div>
                    <img src="../img/services/${service.servicioID}.jpg" alt="imagen-invisible" class="box-product__img">
                </div>
